        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center flex-wrap gap-4">
            ...
            >
             ...
             <Link
              href="/heatmap"
              className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-black bg-white hover:bg-gray-100 transition-transform transform hover:scale-105"
            >
              Explore Crime Map
            </Link>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-black">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="mt-1 text-sm font-semibold text-gray-600">Reports filed in the last hour</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <p className="text-4xl font-bold">2.1 <span className="text-2xl text-gray-400">hrs</span></p>
              <p className="mt-1 text-sm font-semibold text-gray-600">Avg. response time</p>
            </div>
            <div className="bg-white p-6 rounded-lg border border-gray-200 flex items-center justify-center">
