    ...
    return (
        <footer className="bg-gray-900 text-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16">
                ...
                {/* Critical Notice */}
                <div className="mb-12 p-4 bg-yellow-400/10 border border-yellow-500 rounded-lg text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="mt-4 text-gray-400 text-sm font-semibold max-w-xs">
                    ...
                    {Object.entries(footerLinks).map(([title, links]) => (
                        <div key={title}>
                            <h3 className="font-semibold tracking-wider uppercase text-gray-300 text-sm">{title}</h3>
