...
const Hero: React.FC = () => {
  return (
    <div className="relative bg-stone-50 text-stone-800 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-48">
        <div className="max-w-3xl text-center mx-auto">
          ...
          <p className="mt-6 text-lg max-w-2xl mx-auto text-stone-600">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/heatmap"
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3 border border-stone-300 text-base font-medium rounded-md text-stone-800 bg-stone-100/60 hover:bg-stone-200/80 transition-transform transform hover:scale-105"
            >
              View Crime Heatmap
            </Link>
          </div>
